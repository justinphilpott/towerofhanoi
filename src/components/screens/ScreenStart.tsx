  ...
  return (
    <Flex direction="column" justifyContent="space-between" alignItems="center" height="calc(var(--vh, 1vh) * 100)" p={{ base: 6, sm: 8, md: 12, lg: 16, xl: 24 }} pb={{ base: 3, sm: 4, md: 8, lg: 12, xl: 20 }} rounded="6" position="relative">
      ...
      <Flex direction="column" background="rgba(255, 255, 255, 0.9)" p={3} pb={0} rounded={6} mt="auto">
        <Text fontSize="lg" color="#000" m={3} mb={6} textAlign="center" fontWeight="bold">Train your brain with this famous puzzle! A</Text>
      ...
      <Text data-testid="start-credits" textAlign="center" fontSize="sm" mt={1} fontWeight="bold"><Link data-testid="credits-exit" onClick={ () => send({ type: "CREDITS" }) }>~ Credits ~</Link></Text>
    </Flex>
  )
}
