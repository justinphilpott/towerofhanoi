  ...
  return (
    <>
      ...
      <Flex direction="column" width="100%" maxWidth="1200px" background="rgba(255, 255, 255, 0.9)" p="6" rounded="6">
        ...
        <Text fontSize={{base: "0.8rem", md: "1rem", lg:"1.5rem"}} mb={2}>Created initially as a test of <Link href="https://xstate.js.org/docs/" fontWeight="bold">XState <ExternalLinkIcon mx="2px" /></Link> and then contributed to the community under a <Link rel="license" href="https://creativecommons.org/licenses/by-nc-sa/4.0/" fontWeight="bold">Creative Commons License <ExternalLinkIcon mx="2px" /></Link>.</Text>
