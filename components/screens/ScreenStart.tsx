      ...
      <Flex direction="column" justifyContent="space-between" height="100vh" p="12" rounded="6">
        ...
        <SlideFade in={true} offsetY="20px">
          <Flex direction="row" flexWrap="wrap" background="rgba(255, 255, 255, 0.9)" p="6" pb={0} rounded="6">
            <Button flexGrow={1} flexBasis={0} minWidth="100px" colorScheme="teal" color="#000" m="0 0.5em 1.5em 0.5em" onClick={ () => onPlay() }>Play</Button>
            <Button flexGrow={1} flexBasis={0} minWidth="100px" colorScheme="salmon" color="#000" m="0 0.5em 1.5em 0.5em" onClick={ () => onSettings() }>Settings</Button>
