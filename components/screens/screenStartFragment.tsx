  ...
  return (
    ...
    <Flex direction="column" background="rgba(255, 255, 255, 0.9)" p={3} pb={0} rounded={6} mt="auto">
      ...
      <Flex direction="row" flexWrap="wrap">
        <Button size="md" textShadow="0px 0px 10px #fff" flexGrow={1} flexBasis={0} minWidth="130px" colorScheme="teal" color="#000" m="0 0.5em 1.5em 0.5em" onClick={ () => handleClick('PLAY') }>Play</Button>
